...
This file governs all source/provenance claims in `lovejoy_corpus` after the Round-15 hostile philological re-audit.
...
The following earlier closures are now hypotheses or source-lineage identifications rather than final immediate-carrier claims:
...
- p.117 `common/common/exceptional` sacrifice synthesis as Lovejoy's literal wording;
...
Highest-priority blind pages:

- 004 p.6/MS21, p.8/MS25, p.12/MS53, p.17, p.20, p.22, p.29, p.33, p.42, pp.47–52;
- 005 pp.3–6, p.10, p.11, p.27, p.29, p.47, p.62, p.78, **pp.79–80**, pp.85–86, p.89, p.103, **p.117**, p.119.

Use:

- `research_notes/QUELLENFORSCHUNG_round15_Grafton_grade_critical_reaudit_2026-08-31.md` for the full rationale;
- `research_notes/Quellenforschung_round15_evidence_matrix_2026-08-31.csv` for the claim-by-claim recheck ledger.
