...
4. **1901–07:** Buddhism becomes teaching; 005 remains active through 1905; 1906 produces the `primitive philosophy` theory; in 1907 Lovejoy reviews Deussen’s Vedānta outline and urges attention to Rāmānuja.
...
## New archive axis: Open Court / *The Monist*
...
Batch 15 narrows the container problem: Series 1/Sub-Series 6 Publishing **Box 44** has now been checked through the L-sequence from generic `L` to **Lloyd**, including named folders for Lanman, Laufer and Leuba. There is **no dedicated Lovejoy folder in the visible Box 44 sequence through Lloyd**. Because the sub-series is alphabetically arranged, a named Lovejoy folder, if present, should fall after Lloyd and before the M-correspondents; the exact next container is still not exposed by the public index, so no box number is inferred.

The 1908–09 Smith debate also now has exact public-domain retrieval routes through Internet Archive:
...
The next methodological test is proposition-level: whether Lovejoy’s objection to Smith again treats resemblance/syncretism as a hypothesis requiring specific genealogical evidence rather than proof by similarity.

Best archive request: all MSS 027 items/folders indexed to Arthur O. Lovejoy, c.1905–1909, especially Series 1/Sub-Series 6 Publishing and Series 2 Manuscripts, with the titles **“The Fundamental Concept of the Primitive Philosophy”** and **“The Theory of a Pre-Christian Cult of Jesus,”** plus William Benjamin Smith / *Der Vorchristliche Jesus* material.
...
- [`research_notes/lovejoy_as_orientalist_web_sweep_batch14_open_court_archive_narrowing.md`](research_notes/lovejoy_as_orientalist_web_sweep_batch14_open_court_archive_narrowing.md)
- [`research_notes/lovejoy_as_orientalist_web_sweep_batch15_siu_box44_and_monist_1908_1909_routes.md`](research_notes/lovejoy_as_orientalist_web_sweep_batch15_siu_box44_and_monist_1908_1909_routes.md)

## Immediate queue

1908 Lovejoy + 1909 Smith primary extraction and debate table; SIU MSS 027 Lovejoy container/items; 1906 authority/term→005 image concordance; Washington University `Hist. Relig.` course and 1901 Buddhism syllabus; primary 1907 Deussen review; 004→1898→1902 concordance; 005(1905 Hebrew layer)→1907 concordance; MS-0873 letters; Marillier *Survivance* concordance; MS-0038 drafts; AOS proceedings; Albright/Dumont correspondence; 1933/1948 China comparison.
