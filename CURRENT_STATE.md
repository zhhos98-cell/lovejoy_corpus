...
Default: `Quellenforschung_master_summary_2026-08-23.md`, then the relevant canonical dossier.
...
The final 1906 grammar audit strengthens this firewall: Tylor already combined developmental scale, `primitive philosophy` and a warning against premature whole-object synthesis. Lovejoy's historical interest lies in how inherited classificatory grammar is reweighted and warranted, not in inventing decomposition or developmental aggregation.

---

## Harvard / Paris field architecture

Pre-Lovejoy Harvard is direct-primary controlled as a distributed history-of-religions ecology rather than one transmitted method.
...
Paris/Marillier remains an overlap zone, not a clean Harvard→Paris handoff. Thomas 1898 supplies a second-student product in which form/function/origin are locally separated while the conclusion reaggregates evidence into racial/civilizational geological stages. This is a strong same-workshop control for:
...
It does **not** establish continuous annual Buddhist research, the same physical edition, or Buddhist causation of later history-of-ideas method.

The defensible claim is continuity of **source-controlled interpretive practice across changing objects and scales**.

Canonical: `research_notes/Lovejoy_1906_classificatory_grammar_Shelburne_SuttaNipata_bridge_2026-08-27.md`.

---

## 1902–1905 bridge

1902 supplies affinity ≠ transmission and shows how internal genealogy can make borrowing unnecessary.
...
1906 is now the strongest hinge in the project because Lovejoy's direct primaries within months perform several different scale operations.
...
He then adds `race and nationality` and says the conjunction of stages of social evolution and racial/national genius has destroyed the unity of eighteenth-century `generic Man`, splitting him **`longitudinally and cross-wise`**.
...
Political relativity is **not normative nihilism**. Lovejoy rejects natural-rights absolutism but retains higher consequential/civilizational criteria: general welfare, civil liberty, order, culture, civic virtue, continuity and maintenance/elevation of the `standard of civilization`.
...
### 3. Kant historical-classification control

`Kant's Antithesis of Dogmatism and Criticism`, April 1906, *Mind* 15.58, 191–214.
