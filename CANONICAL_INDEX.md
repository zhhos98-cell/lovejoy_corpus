...
Historical status language inside dated notes does not override these living files.

## 1. Core authority

| Need | Use |
|---|---|
| Current project state / active tracks | `CURRENT_STATE.md` |
| Historical argument architecture | `PROJECT_ARGUMENT_MAP.md` |
| Diplomatic transcription completion | `TRANSCRIPTION_COMPLETION_QUEUE.md` |
...
| Integrated notebook reading surface | `archive_transcriptions/MS38_004_005_integrated_page_by_page_final_2026-09-01.md` |
| Full notebook-to-1898 page concordance | `research_notes/MS38_004_005_to_1898_page_concordance_full_coverage_2026-09-03.md` + `.csv` |
...
| Research-note routing | `research_notes/README.md` |
...
The integrated file is a working reading surface generated from canonical page records. Its legacy filename contains `final`; this does not mean full diplomatic transcription is complete.

Material/audit controls include:
...
## 3. Archive / source-critical track

Use `CURRENT_STATE.md` for the exact live queue.

### Notebook 004

Current routed controls:
...
State: 71/71 first-pass page coverage; high-value clause ownership closed for the present argument; diplomatic residue remains.

### Notebook 005

Current terminal/source-version routing:

- `research_notes/QUELLENFORSCHUNG_round33_005_targeted_HOLD_p117_ranked_frequency_authorship_ceiling_2026-09-03.md` — principal source/version HOLD;
- `research_notes/QUELLENFORSCHUNG_round37_005_p087_Strack_immediate_carrier_ceiling_2026-09-03.md` — current p.87 carrier ceiling;
- `research_notes/MS38_005_pp031-036_Marillier_source_collation_2026-09-02.md` — external-source collation, not manuscript-text authority;
...
State: 120/120 first-pass page coverage; broad source ownership closed; targeted adjudication through Round 37; diplomatic transcription incomplete.

Do not use failed source recovery as evidence of Lovejoy originality.

## 4. AOS 1897 / Milinda / 1898 publication path

Full page-accounting authority:
...
Current title-path synthesis:

- `research_notes/lovejoy_1897_title_contraction_to_1906_relational_scale_control_batch221.md`

Safe state: Lovejoy was absent; No.30 was read by title; corporate election is direct; Historical Study of Religions Section membership is not established; the 1897 technical-terms title is a strong publication-path precursor to the 1898 article; manuscript identity remains unproved.

## 5. Harvard / Boston / Paris formation
...
- `research_notes/Brinton_Boston_1896_97_Harvard_history_of_religions_local_infrastructure_2026-08-31.md`
...
1. `research_notes/lovejoy_005_primitive_as_relational_strata_non_synchronized_chronology_batch208.md`
2. `research_notes/lovejoy_004_005_chronological_nonisomorphism_relational_time_batch209.md`
...
- `research_notes/martin_guerre_21c_readme.md`

These calibrate method claims. They do not displace the Lovejoy archival core and do not enter the Lovejoy evidence chain unless a direct historical relation is independently established.

## 9. Provenance and cleanup policy

- `archive_index/` = locators, custody, archive coverage, reproduction/rights status, search provenance.
- `archive_transcriptions/` = canonical page records, deltas, material audits, integrated reading surface.
- `research_notes/` = terminal dossiers, comparative controls, and historical batch/process provenance.
